  ...
  km: {
    translation: {
      ...
      customerSupport: {
        ...
        description:
          "សេវាដោះស្រាយបញ្ហាពីចម្ងាយរបស់យើងផ្តល់នូវដំណោះស្រាយរហ័ស និងអាចទុកចិត្តបានសម្រាប់បញ្ហា RetailManager POS RM Multi-store និង Webstore Manager។ មានមូលដ្ឋាននៅសៀមរាប កម្ពុជា យើងផ្តល់ការគាំទ្រពីអ្នកជំនាញដល់អតិថិជនអូស្ត្រាលី - ដោះស្រាយកំហុសផ្នែក Computer បញ្ហាភ្ជាប់ និងបញ្ហាមូលដ្ឋានទិន្នន័យយ៉ាងឆាប់រហ័ស ដើម្បីកាត់បន្ថយពេលវេលារងចាំ និងរក្សាអាជីវកម្មរបស់អ្នកដំណើរការដោយរលូន។",
      ...
      services: {
        header: {
          ...
          title: "សេវាកម្មរបស់យើង",
          description:
            "ដំណោះស្រាយគ្រប់គ្រងអាជីវកម្មពេញលេញ រួមមានប្រព័ន្ធ POS ការគ្រប់គ្រងហាងអនឡាញ ប្រតិបត្តិការហាងច្រើន និងការបង្ហោះគេហទំព័រអាជីព។",
        },
        pos: {
          title: "ប្រព័ន្ធគ្រប់គ្រងការលក់ (POS)",
          description:
            "ដំណោះស្រាយគ្រប់គ្រងអាជីវកម្មពិសេសរួមមានការតាមដានស្តុក របាយការណ៍លក់ និងលក្ខណៈពិសេសគ្រប់គ្រងពត៏មានរបស់អតិថិជន។",
        },
        webstore: {
