  ...
  const contactMethods = [
    {
      ...
      description:
        settings.address || t("contactPage.contactMethods.address.fallback"),
    },
    {
      icon: <HiOutlinePhone className="contact-icon" />,
      title: t("contactPage.contactMethods.phone.title"),
      description:
        settings.phoneNumber || t("contactPage.contactMethods.phone.fallback"),
    },
    {
      icon: <HiOutlineEnvelope className="contact-icon" />,
      title: t("contactPage.contactMethods.email.title"),
      description:
        settings.email || t("contactPage.contactMethods.email.fallback"),
    },
  ];
      ...
      {showRecaptchaModal && (
        ...
        >
          ...
          >
            ...
            <div
              className="absolute inset-0 bg-gradient-to-br from-cyan-50/30 to-blue-50/30 dark:from-cyan-900/10 dark:to-blue-900/10 -z-10"
              style={{
                background:
                  "linear-gradient(135deg, rgba(15, 138, 190, 0.05) 0%, rgba(15, 138, 190, 0.02) 100%)",
              }}
            ></div>
            ...
            <div className="text-center mb-6">
              ...
              <motion.h3
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #0f8abe 0%, #0a6b8f 100%)",
              ...
              >
                Help us keep our platform secure by completing the verification
                below
              </motion.p>
            </div>
            ...
            >
              <div
                className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-inner border-2"
                style={{ borderColor: "#0f8abe20" }}
              >
                <ReCAPTCHA
                  ref={recaptchaRef}
            ...
            {recaptchaValue && (
              <motion.div
                ...
                style={{ color: "#0f8abe" }}
              >
                <motion.div className="w-4 h-4 rounded-full border-2 border-current border-t-transparent animate-spin"></motion.div>
                <span className="text-sm font-medium">
                  Verification successful! Sending message...
                </span>
              </motion.div>
            )}
          </motion.div>
