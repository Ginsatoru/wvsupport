...
const HeroAddModal = ({ isOpen, onClose, onSuccess, darkMode: darkModeProp }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!imageFile) { toast.error('Background image is required'); return; }
    setSubmitting(true);
    try {
    ...
    } catch (error) { toast.error(error.message || 'Failed to create hero content'); }
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-scaleIn">
        <div className="p-5">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-bold" style={{ color: textColor }}>Add New Hero</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="border-t border-gray-200 dark:border-gray-600 pt-4 space-y-3">
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="isActive" className="ml-2 text-xs" style={{ color: textColor }}>Set as active hero (will deactivate others)</label>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2 pt-3">
              ...
              <button type="submit" disabled={submitting}
                ...
                {submitting ? (<><Loader2 className="w-3 h-3 animate-spin" />Creating...</>) : (<><Save size={14} />Create</>)}
              </button>
            </div>
          </form>
        </div>
